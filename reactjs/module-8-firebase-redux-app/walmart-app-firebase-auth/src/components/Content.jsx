...
<div className="bg-blue-600 text-white p-4 sm:p-6 lg:p-8 shadow-2xl w-320 rounded-3xl mt-10 mx-auto">
...
{data && data.map((items)=>{
  return(
   ...
   <div className='p-5 mt-0'>
    ...
    <p className='text-center text-xl mt-4'>Rs. {items.newprice} <span><del>{items.oldprice}</del></span></p>
    <p className='text-center mt-4'>{items.productname}</p>
    <p className='text-center mt-8 text-lg'><button type='button' onClick={()=>{navigate(`/product-details/${items.id}`)}} className='bg-blue-600 text-white rounded-4xl p-3'>More Details <FaPlus className="inline-flex" /></button></p>
   </div>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      ...
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-700">
        We are here to help you with your shopping experience. Reach out to us
        for store information, hours, or any other inquiries.
      </p>
    </div>
