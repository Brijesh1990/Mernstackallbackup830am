  ...
  <>
    ...
    <div className='p-0 w-full flex flex-row'>
      ...
      <div className='w-full p-5 mt-32'>
        <h1 className='text-3xl ms-5 p-5 mt-10'>Manage Contact  <button type='button' className='bg-red-600 text-white p-2 float-end'>Export In Excel</button></h1>
            ...
            <tbody>
              {filteredData.map((row) => (
                <tr className='hover:bg-gray-100 text-center' key={row._id || row.id}>
                  ...
                  <button type='button' className='bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600' onClick={()=>{navigate(`/admin-login/manage-contact/${row.id}`)}}>
                      Delete
                    </button>
                  </td>
                </tr>
